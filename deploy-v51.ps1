# PokéDax v5.1 — Forum-Fix (Array.isArray für Supabase-Joins)
$root = "C:\Users\lenovo\pokedax\pokedax\pokedax"
$enc  = New-Object System.Text.UTF8Encoding $true
Write-Host "pokEdax v5.1 — Forum TypeScript Fix" -ForegroundColor Cyan
...
Write-Host ""
Write-Host "=====================================" -ForegroundColor Cyan
Write-Host "v5.1 fertig!" -ForegroundColor Cyan
Write-Host "=====================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "Fix: forum/page.tsx - Array.isArray fuer Supabase-Joins" -ForegroundColor Green
Write-Host ""
Write-Host "GitHub Desktop -> Commit 'v5.1: forum type fix'" -ForegroundColor Yellow
