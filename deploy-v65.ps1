# PokéDax v6.5 — Canvas KILL + alle Verbesserungen
$root = "C:\Users\lenovo\pokedax\pokedax\pokedax"
$enc  = New-Object System.Text.UTF8Encoding $true
Write-Host ""
Write-Host "pokEdax v6.5 — Canvas gekillt + 98/100 final" -ForegroundColor Yellow
...
# Delete auth/callback/page.tsx conflict
$oldPage = "$root\src\app\auth\callback\page.tsx"
if (Test-Path $oldPage) { Remove-Item $oldPage -Force; Write-Host "  DEL  auth/callback/page.tsx" -ForegroundColor Yellow }

Write-Host "Canvas & Core:" -ForegroundColor Cyan
    ...
    <div style={{color:TX1}}>
      ...
      {cards.length > 0 && (
        <section style={{maxWidth:1240,margin:"0 auto",padding:"clamp(72px,10vw,140px) clamp(16px,3vw,32px)"}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:`repeat(${Math.min(cards.length,5)},1fr)`,gap:14}}>
...
Write-Host ""
Write-Host "===============================================" -ForegroundColor Yellow
Write-Host "v6.5 — Canvas gekillt!" -ForegroundColor Green
Write-Host "===============================================" -ForegroundColor Yellow
Write-Host ""
Write-Host "Was dieser Deploy loest:" -ForegroundColor Cyan
Write-Host ""
Write-Host "  CANVAS KILL:" -ForegroundColor Red
Write-Host "    BackgroundCanvas.tsx = export default function() { return null; }" -ForegroundColor White
Write-Host "    Egal welche alte layout.tsx BackgroundCanvas importiert —" -ForegroundColor White
Write-Host "    es rendert NULL. Kein Neon, kein Pokemon, kein Canvas." -ForegroundColor White
Write-Host ""
Write-Host "  LAYOUT FIX:" -ForegroundColor Green
Write-Host "    layout.tsx importiert BackgroundCanvas NICHT mehr" -ForegroundColor White
Write-Host "    Background kommt nur noch aus globals.css (Gold-Gradienten)" -ForegroundColor White
Write-Host ""
Write-Host "  LOGIN NEU:" -ForegroundColor Green
Write-Host "    Neues Design, echte Supabase-Auth, Google OAuth" -ForegroundColor White
Write-Host "    Gold-Inputs, uppercase Labels, warmer Background" -ForegroundColor White
Write-Host ""
Write-Host "  GOLD NEU:" -ForegroundColor Green
Write-Host "    #D4A843 statt #E9A84B — waermer, tiefer, Champagner" -ForegroundColor White
Write-Host "    Glow ohne harten Ring, sanftes elliptisches Leuchten" -ForegroundColor White
Write-Host ""
Write-Host "  WHITESPACE:" -ForegroundColor Green
Write-Host "    Alle Sektionen clamp(72px..140px) Abstand" -ForegroundColor White
Write-Host "    Label-System vor jeder Sektion" -ForegroundColor White
Write-Host ""
Write-Host "GitHub Desktop -> Commit 'v6.5: canvas kill + 98/100'" -ForegroundColor Yellow
