# PokéDax v6.8 — KI-Scanner + Fantasy + Matching
$root = "C:\Users\lenovo\pokedax\pokedax\pokedax"
$enc  = New-Object System.Text.UTF8Encoding $true
Write-Host ""
Write-Host "pokEdax v6.8 — Features komplett!" -ForegroundColor Yellow
Write-Host "===================================" -ForegroundColor Yellow
Write-Host ""
Write-Host "Neu in v6.8:" -ForegroundColor Cyan
Write-Host "  [1] Echter KI-Scanner mit Gemini Flash Vision" -ForegroundColor Green
Write-Host "  [2] 5/Tag-Limit fuer Free, unlimitiert fuer Premium" -ForegroundColor Green
Write-Host "  [3] Matching nach Scan (Kauf- und Suchangebote)" -ForegroundColor Green
Write-Host "  [4] Fantasy League komplett (Team-Builder + Leaderboard)" -ForegroundColor Green
Write-Host "  [5] Neue API-Routes: scanner/scan, scanner/count, marketplace, fantasy/team, fantasy/leaderboard" -ForegroundColor Green
Write-Host ""
...
$dirs = @(
  ...
  "$root\src\app\api\marketplace","$root\src\app\api\fantasy\team","$root\src\app\api\fantasy\leaderboard",
...
'@
[System.IO.File]::WriteAllText("$root\src\app\api\scanner\scan\route.ts", $scannerRoute, $enc)
Write-Host "  OK  route.ts" -ForegroundColor Green
...
Write-Host ""
Write-Host "===================================" -ForegroundColor Yellow
Write-Host "v6.8 fertig!" -ForegroundColor Yellow
Write-Host "===================================" -ForegroundColor Yellow
Write-Host ""
Write-Host "WICHTIG — Vercel Env Vars eintragen:" -ForegroundColor Red
Write-Host "  GEMINI_API_KEY = AIza... (von aistudio.google.com)" -ForegroundColor White
Write-Host "  STRIPE_SECRET_KEY, STRIPE_PRICE_ID_PREMIUM etc." -ForegroundColor White
Write-Host ""
Write-Host "WICHTIG — Supabase SQL ausfuehren:" -ForegroundColor Red
Write-Host "  Die fantasy_teams, fantasy_picks, marketplace_listings Tabellen" -ForegroundColor White
Write-Host "  SQL liegt in der Chat-Nachricht oben" -ForegroundColor White
Write-Host ""
Write-Host "GitHub Desktop -> Commit 'v6.8: scanner+fantasy+matching'" -ForegroundColor Yellow
