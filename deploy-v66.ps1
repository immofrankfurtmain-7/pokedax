# PokéDax v6.6 — Phase 1: Stripe live + Kartenbilder + Auth Layout Fix
$root = "C:\Users\lenovo\pokedax\pokedax\pokedax"
$enc  = New-Object System.Text.UTF8Encoding $true
Write-Host ""
Write-Host "pokEdax v6.6 — Phase 1 komplett" -ForegroundColor Yellow
...
Write-Host "Fix 1: next.config.js (TCGdex Bilder)" -ForegroundColor Red
Write-Host "Fix 2: auth/layout.tsx (kein MewtwoCanvas)" -ForegroundColor Red
Write-Host "Fix 3: Premium-Seite (echter Stripe Checkout)" -ForegroundColor Red
Write-Host "Fix 4: Stripe APIs + Hooks" -ForegroundColor Red
Write-Host ""
...
Write-Host ""
Write-Host "================================" -ForegroundColor Yellow
Write-Host "v6.6 Phase 1 fertig!" -ForegroundColor Yellow
Write-Host "================================" -ForegroundColor Yellow
Write-Host ""
Write-Host "Was dieser Deploy macht:" -ForegroundColor Cyan
Write-Host ""
Write-Host "  [1] KARTENBILDER" -ForegroundColor Green
Write-Host "      next.config.js erlaubt jetzt assets.tcgdex.net" -ForegroundColor White
Write-Host "      -> Bilder erscheinen im Preischeck und Karten-Grid" -ForegroundColor White
Write-Host ""
Write-Host "  [2] AUTH LAYOUT" -ForegroundColor Green
Write-Host "      src/app/auth/layout.tsx - kein MewtwoCanvas mehr" -ForegroundColor White
Write-Host "      -> Login/Register: sauberer Gold-Hintergrund" -ForegroundColor White
Write-Host ""
Write-Host "  [3] STRIPE LIVE" -ForegroundColor Green
Write-Host "      Premium-Seite hat echte Checkout-Buttons" -ForegroundColor White
Write-Host "      Checkout + Webhook APIs deployed" -ForegroundColor White
Write-Host "      -> Noch benoetigt: Vercel Env Vars setzen!" -ForegroundColor Yellow
Write-Host ""
Write-Host "WICHTIG - Vercel Env Vars (Settings -> Environment Variables):" -ForegroundColor Red
Write-Host "  STRIPE_SECRET_KEY       = sk_live_..." -ForegroundColor White
Write-Host "  STRIPE_PRICE_ID_PREMIUM = price_..." -ForegroundColor White
Write-Host "  STRIPE_PRICE_ID_DEALER  = price_..." -ForegroundColor White
...
Write-Host ""
Write-Host "Stripe Webhook URL in Stripe Dashboard:" -ForegroundColor Yellow
Write-Host "  https://pokedax2.vercel.app/api/webhooks/stripe" -ForegroundColor White
Write-Host "  Events: checkout.session.completed, invoice.payment_succeeded," -ForegroundColor White  
Write-Host "          invoice.payment_failed, customer.subscription.deleted" -ForegroundColor White
Write-Host ""
Write-Host "GitHub Desktop -> Commit 'v6.6: stripe live + card images + auth fix'" -ForegroundColor Yellow
