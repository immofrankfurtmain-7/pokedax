# PokéDax v6.9 — Alle 8 Bugs gefixt + Forum Redesign
$root = "C:\Users\lenovo\pokedax\pokedax\pokedax"
$enc  = New-Object System.Text.UTF8Encoding $true
Write-Host ""
Write-Host "pokEdax v6.9" -ForegroundColor Yellow
Write-Host "============" -ForegroundColor Yellow
Write-Host ""
Write-Host "Fixes:" -ForegroundColor Cyan
Write-Host "  [1] Navbar: Portfolio nur einmal, Sets + Marktplatz neu" -ForegroundColor Green
Write-Host "  [2] Marketplace: eigene Seite /marketplace" -ForegroundColor Green
Write-Host "  [3] Leaderboard: Portfolio-Wert als Hauptranking (echte DB-Daten)" -ForegroundColor Green
Write-Host "  [4] Sets: /sets Seite wiederhergestellt" -ForegroundColor Green
Write-Host "  [5] Fantasy: besseres Error Handling" -ForegroundColor Green
Write-Host "  [6] Portfolio: 7T/30T/90T Chart-Tabs klickbar" -ForegroundColor Green
Write-Host "  [7] Forum: komplettes Redesign (Reddit/Linear-Stil)" -ForegroundColor Green
Write-Host "  [8] Neue APIs: /api/leaderboard/portfolio, /api/marketplace" -ForegroundColor Green
Write-Host ""
...
Write-Host ""
Write-Host "============" -ForegroundColor Yellow
Write-Host "v6.9 fertig!" -ForegroundColor Yellow
Write-Host "============" -ForegroundColor Yellow
Write-Host ""
Write-Host "GitHub Desktop -> Commit 'v6.9: 8 fixes + forum redesign + portfolio leaderboard'" -ForegroundColor Yellow
Write-Host "-> Push -> Vercel" -ForegroundColor White
Write-Host ""
Write-Host "Nicht vergessen:" -ForegroundColor Red
Write-Host "  GEMINI_API_KEY in Vercel Env Vars" -ForegroundColor White
Write-Host "  SQL fuer fantasy_teams, fantasy_picks, marketplace_listings ausfuehren" -ForegroundColor White
Write-Host ""
