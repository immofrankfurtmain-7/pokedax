# PokeDax v43 - Hero fix + Trending Cards
$root = "C:\Users\lenovo\pokedax\pokedax\pokedax"
$enc  = New-Object System.Text.UTF8Encoding $true
Write-Host "PokeDax v43 - Hero + Trending Cards Fix" -ForegroundColor Cyan
...
Write-Host ""
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "v43 fertig!" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "Fixes:" -ForegroundColor Green
Write-Host "  Hero-Text jetzt explizit color:#EDEAF6 (war unsichtbar)" -ForegroundColor White
Write-Host "  layout.tsx: z-index:1 Wrapper (Canvas-Fix bleibt)" -ForegroundColor White
Write-Host "  Startseite: echte Trending-Cards aus Supabase" -ForegroundColor White
Write-Host "  Stats zeigen echte Zahlen aus DB" -ForegroundColor White
Write-Host "  Scanner-CTA verbessert mit zwei Buttons" -ForegroundColor White
Write-Host "  Kein HeroClient mehr noetig (Server Component)" -ForegroundColor White
Write-Host ""
Write-Host "GitHub Desktop -> Commit 'v43: hero fix + trending cards'" -ForegroundColor Yellow
