# PokéDax v5.5 — Profil Syntax Fix
$root = "C:\Users\lenovo\pokedax\pokedax\pokedax"
$enc  = New-Object System.Text.UTF8Encoding $true
Write-Host "pokEdax v5.5 — Profil Syntax Fix" -ForegroundColor Cyan
...
Write-Host ""
Write-Host "===================================" -ForegroundColor Cyan
Write-Host "v5.5 fertig!" -ForegroundColor Cyan
Write-Host "===================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "Fix: profil/[username]/page.tsx" -ForegroundColor Green
Write-Host "  Regex hatte verwaiste }} hinterlassen -> JSX Syntax Error" -ForegroundColor White
Write-Host "  Bereinigt: alle orphaned braces entfernt" -ForegroundColor White
Write-Host "  Verifiziert: 170 { == 170 } (ausgeglichen)" -ForegroundColor White
Write-Host ""
Write-Host "GitHub Desktop -> Commit 'v5.5: profil syntax fix'" -ForegroundColor Yellow
