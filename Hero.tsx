    ...
    <section ref={ref} className="relative min-h-screen flex items-center overflow-hidden pt-[60px]">
      ...
      <motion.div style={{ y, opacity }} className="relative z-10 max-w-7xl mx-auto px-6 w-full">
        <div className="max-w-[580px]">
          ...
          >
            Pokémon TCG
            <span className="gradient-text block mt-2">Preis-Check DE</span>
          </motion.h1>
          ...
          >
            <Link href="/preischeck"
              className="group inline-flex items-center gap-2.5 px-7 py-3.5 rounded-2xl font-bold text-[15px] bg-gradient-to-r from-violet-600 to-purple-500 text-white shadow-[0_8px_28px_rgba(124,58,237,0.5)] hover:shadow-[0_12px_36px_rgba(124,58,237,0.65)] hover:-translate-y-0.5 transition-all">
              <Search size={18} className="group-hover:scale-110 transition-transform"/>
              Preis checken
            </Link>
            <Link href="/scanner"
              className="group inline-flex items-center gap-2.5 px-7 py-3.5 rounded-2xl font-semibold text-[15px] border border-white/15 bg-white/4 text-white/80 hover:bg-white/9 hover:border-white/25 hover:-translate-y-0.5 backdrop-blur-md transition-all">
