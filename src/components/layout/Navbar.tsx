      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="h-20 flex items-center justify-between">
          ...
          <Link href="/" className="flex-shrink-0">
            <span className="font-display text-[22px] font-light tracking-[-0.075em] text-[var(--tx-1)]">
              pokédax
            </span>
          </Link>

          {/* Zentrierte Navigation */}
          <div className="hidden md:flex absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 items-center gap-10 text-sm font-medium">
            <Link 
              href="/preischeck" 
              className="text-[var(--tx-2)] hover:text-[var(--tx-1)] transition-all gold-glow px-5 py-3 rounded-2xl"
            >
              Preischeck
            </Link>
            <Link 
          ...
          <div className="flex items-center gap-5 flex-shrink-0">
            ...
            <Link 
              ...
              className="px-7 py-3 bg-[var(--gold)] text-[#0a0a0a] font-semibold text-sm rounded-3xl gold-glow hover:bg-[#d19a3f] transition-all"
            >
              Premium
            </Link>
            ...
            <button
              ...
              className="md:hidden w-9 h-9 flex items-center justify-center text-[var(--tx-2)] hover:text-[var(--tx-1)] transition-colors"
            >
