...
// GET /api/matches — user's wishlist matches
export async function GET(request: NextRequest) {
  ...
  const { data } = await supabase
    ...
    .select(`
      id, created_at, dismissed, match_score, price_delta_pct,
      listing_id,
...
// PATCH /api/matches — dismiss a match
