                  ...
                  <div className="flex items-start gap-3">
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1 flex-wrap">
                        {post.is_pinned && (
                          <span className="text-xs px-1.5 py-0.5 rounded bg-purple-900 text-purple-300">Angepinnt</span>
                        )}
                        {post.is_locked && (
                          <span className="text-xs px-1.5 py-0.5 rounded bg-gray-700 text-gray-400">Gesperrt</span>
                        )}
