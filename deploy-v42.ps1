# ╔══════════════════════════════════════════════════════╗
# ║  PokéDax v42 — Design System v2                      ║
# ║  Gold #E9A84B · 5-Layer BG · Linear/Arc Qualität    ║
# ╚══════════════════════════════════════════════════════╝
$root = "C:\Users\lenovo\pokedax\pokedax\pokedax"
$enc  = New-Object System.Text.UTF8Encoding $true

Write-Host ""
Write-Host "PokeDax v42 - Design System v2" -ForegroundColor Cyan
...
$dirs = @(
  ...
  "$root\src\app\top-movers",
  "$root\src\app\forum",
  "$root\src\app\api\cards\search",
  "$root\src\app\api\cards\sets",
  "$root\src\app\api\admin\sync-sets",
  "$root\src\app\api\admin\sync-cards",
  "$root\src\app\api\stats",
  "$root\src\components\layout",
  "$root\src\components\ui",
  "$root\src\components\premium",
  "$root\public"
)
foreach ($d in $dirs) {
...
Write-Host "Design System (neu):" -ForegroundColor Yellow
...
Write-Host ""
Write-Host "==============================" -ForegroundColor Cyan
Write-Host "v42 fertig!" -ForegroundColor Cyan
Write-Host "==============================" -ForegroundColor Cyan
Write-Host ""
Write-Host "Geaendert:" -ForegroundColor Yellow
Write-Host "  globals.css: Gold #E9A84B, 5-Ebenen-BG, DM Mono" -ForegroundColor White
Write-Host "  layout.tsx:  FloatingPikachu entfernt, Inter 300-600" -ForegroundColor White
Write-Host "  Navbar.tsx:  56px, blur(28px), Gold Active-Line" -ForegroundColor White
Write-Host "  page.tsx:    Hero mit Count-Up, echte Karten, Scanner-CTA" -ForegroundColor White
Write-Host "  not-found:   Pokeball-Animation" -ForegroundColor White
Write-Host ""
Write-Host "Unveraendert (Daten/API/Payments):" -ForegroundColor Gray
Write-Host "  Supabase: alle Karten, Nutzer, Sammlung, Wunschliste" -ForegroundColor Gray
Write-Host "  Stripe: Webhooks, Checkout, Premium-Status" -ForegroundColor Gray
Write-Host "  TCGdex: sync-cards, sync-sets Routen" -ForegroundColor Gray
Write-Host ""
Write-Host "Naechster Schritt:" -ForegroundColor Yellow
Write-Host "  GitHub Desktop -> Commit 'v42: Design System v2'" -ForegroundColor White
