$file = "C:\Users\lenovo\pokedax\src\app\api\webhooks\stripe\route.ts"
...
# Remove the Write-Host line (was placeholder) - fix content
$content = $content -replace "        Write-Host `"noop`"`n        break", "        break"
