# PokeDax Forum Redesign v4 - duplicate upvotes fix
$root = "C:\Users\lenovo\pokedax\pokedax\pokedax"
$enc = New-Object System.Text.UTF8Encoding $true
Write-Host "Deploy v4..." -ForegroundColor Cyan
$dirs = @("$root\src\app\forum","$root\src\app\forum\new","$root\src\app\api\forum\posts")
...
if (-not (Test-Path -LiteralPath $postDir)) { New-Item -ItemType Directory -LiteralPath $postDir -Force | Out-Null }
