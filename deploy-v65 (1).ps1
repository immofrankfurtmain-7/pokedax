# PokéDax v6.5 — Triple Canvas Kill
$root = "C:\Users\lenovo\pokedax\pokedax\pokedax"
$enc  = New-Object System.Text.UTF8Encoding $true
Write-Host ""
Write-Host "pokEdax v6.5 — Triple Canvas Kill" -ForegroundColor Red
...
Write-Host "KILL 1: BackgroundCanvas -> null" -ForegroundColor Red
Write-Host "KILL 2: layout.tsx body background #09090b" -ForegroundColor Red
Write-Host "KILL 3: globals.css canvas { display:none }" -ForegroundColor Red
Write-Host ""
...
Write-Host ""
Write-Host "===================================" -ForegroundColor Red
Write-Host "v6.5 Canvas GEKILLT!" -ForegroundColor Red  
Write-Host "===================================" -ForegroundColor Red
Write-Host ""
Write-Host "3-facher Kill:" -ForegroundColor White
Write-Host "  1. BackgroundCanvas.tsx = return null" -ForegroundColor White
Write-Host "  2. body { background: #09090b } direkt in layout.tsx" -ForegroundColor White
Write-Host "  3. canvas[aria-hidden] { display:none } in globals.css" -ForegroundColor White
Write-Host ""
Write-Host "GitHub Desktop -> Commit 'v6.5: canvas kill'" -ForegroundColor Yellow
