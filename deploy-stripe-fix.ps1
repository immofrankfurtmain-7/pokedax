# PokeDax Stripe Fix v2 – Checkout Route repariert
$root = "C:\Users\lenovo\pokedax\pokedax\pokedax"
$enc  = New-Object System.Text.UTF8Encoding $true
Write-Host "Stripe Fix v2..." -ForegroundColor Cyan
...
Write-Host ""
Write-Host "Fertig! Was behoben wurde:" -ForegroundColor Cyan
Write-Host "  - Stripe lazy initialisiert (kein Crash beim Start)" -ForegroundColor White
Write-Host "  - Korrekte API Version 2023-10-16" -ForegroundColor White
Write-Host "  - Try/Catch mit echten Fehlermeldungen" -ForegroundColor White
Write-Host "  - sepa_debit entfernt (manchmal nicht aktiviert)" -ForegroundColor White
Write-Host ""
Write-Host "GitHub Desktop -> Commit & Push" -ForegroundColor Yellow
Write-Host ""
Write-Host "Nach dem Deploy in Browser-Konsole pruefen:" -ForegroundColor Yellow
Write-Host "  F12 -> Network -> /api/stripe/checkout anklicken" -ForegroundColor Gray
Write-Host "  Dort steht der genaue Fehler" -ForegroundColor Gray
