# PokeDax v42b - WishlistBtn Fix
$root = "C:\Users\lenovo\pokedax\pokedax\pokedax"
$enc  = New-Object System.Text.UTF8Encoding $true
Write-Host "PokeDax v42b - WishlistBtn Fix" -ForegroundColor Cyan
...
Write-Host ""
Write-Host "==============================" -ForegroundColor Cyan
Write-Host "v42b fertig!" -ForegroundColor Cyan
Write-Host "==============================" -ForegroundColor Cyan
Write-Host ""
Write-Host "Fix: WishlistBtn jetzt korrekt definiert in preischeck/page.tsx" -ForegroundColor Green
Write-Host ""
Write-Host "GitHub Desktop -> Commit 'v42b: WishlistBtn fix'" -ForegroundColor Yellow
