# PokeDax Forum Redesign v3 - like_count -> upvotes Fix
# Ausfuehren: powershell -ExecutionPolicy Bypass -File deploy-forum-v3.ps1

$root = "C:\Users\lenovo\pokedax\pokedax\pokedax"
$enc = New-Object System.Text.UTF8Encoding $true

Write-Host "PokeDax Forum Redesign v3 wird installiert..." -ForegroundColor Cyan
...
Write-Host "GitHub Desktop -> Commit & Push -> fertig." -ForegroundColor Yellow
