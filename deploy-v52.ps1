# PokéDax v5.2 — not-found Static Generation Fix
$root = "C:\Users\lenovo\pokedax\pokedax\pokedax"
$enc  = New-Object System.Text.UTF8Encoding $true
Write-Host "pokEdax v5.2 — not-found timeout fix" -ForegroundColor Cyan
...
Write-Host ""
Write-Host "======================================" -ForegroundColor Cyan
Write-Host "v5.2 fertig!" -ForegroundColor Cyan
Write-Host "======================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "Fixes:" -ForegroundColor Green
Write-Host "  not-found.tsx: 'use client' entfernt (war Ursache des Timeouts)" -ForegroundColor White
Write-Host "  not-found.tsx: CSS animation entfernt (braucht kein client JS)" -ForegroundColor White
Write-Host "  forum/page.tsx: Array.isArray fix bereits enthalten" -ForegroundColor White
Write-Host ""
Write-Host "GitHub Desktop -> Commit 'v5.2: not-found static fix'" -ForegroundColor Yellow
