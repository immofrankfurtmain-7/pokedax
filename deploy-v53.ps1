# PokéDax v5.3 — All Static Generation Fixes
$root = "C:\Users\lenovo\pokedax\pokedax\pokedax"
$enc  = New-Object System.Text.UTF8Encoding $true
Write-Host "pokEdax v5.3 — Complete Build Fix" -ForegroundColor Cyan
...
Write-Host ""
Write-Host "APIs (force-dynamic added):" -ForegroundColor Yellow
...
Write-Host ""
Write-Host "===================================" -ForegroundColor Cyan
Write-Host "v5.3 fertig!" -ForegroundColor Cyan
Write-Host "===================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "Alle Build-Fehler behoben:" -ForegroundColor Green
Write-Host "  Footer.tsx: 'use client' hinzugefuegt (hatte hover-Events)" -ForegroundColor White
Write-Host "  page_home.tsx: onMouseEnter/Leave entfernt (Server Component)" -ForegroundColor White
Write-Host "  not-found.tsx: 'use client' entfernt (static timeout)" -ForegroundColor White
Write-Host "  dashboard/premium: force-dynamic (kein static build)" -ForegroundColor White
Write-Host "  auth/login + register: force-dynamic" -ForegroundColor White
Write-Host "  impressum + datenschutz: force-dynamic" -ForegroundColor White
Write-Host "  /api/stats + /api/stats/ticker: force-dynamic" -ForegroundColor White
Write-Host "  forum/page.tsx: Array.isArray fix" -ForegroundColor White
Write-Host ""
Write-Host "GitHub Desktop -> Commit 'v5.3: all build fixes'" -ForegroundColor Yellow
