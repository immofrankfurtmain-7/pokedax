# PokéDax v6.4 — Canvas Fix + Neues Design
$root = "C:\Users\lenovo\pokedax\pokedax\pokedax"
$enc  = New-Object System.Text.UTF8Encoding $true
Write-Host ""
Write-Host "pokEdax v6.4 — Canvas Fix + Weltklasse Design" -ForegroundColor Yellow
...
# Loesche auth/callback/page.tsx Konflikt
...
Write-Host ""
Write-Host "===============================================" -ForegroundColor Yellow
Write-Host "v6.4 fertig!" -ForegroundColor Yellow
Write-Host "===============================================" -ForegroundColor Yellow
Write-Host ""
Write-Host "KEY FIX: BackgroundCanvas.tsx gibt jetzt null zurueck" -ForegroundColor Green
Write-Host "  -> Kein Neon-Pokemon-Hintergrund mehr auf Login/Register" -ForegroundColor White
Write-Host "  -> Background kommt jetzt nur noch aus globals.css" -ForegroundColor White
Write-Host "  -> Warme Gold-Gradienten auf body (background-attachment:fixed)" -ForegroundColor White
Write-Host ""
Write-Host "GitHub Desktop -> Commit 'v6.4: canvas fix + weltklasse design'" -ForegroundColor Yellow
