# PokeDax v42d - Z-Index Fix (Seite war hinter Canvas versteckt)
$root = "C:\Users\lenovo\pokedax\pokedax\pokedax"
$enc  = New-Object System.Text.UTF8Encoding $true
Write-Host "PokeDax v42d - Z-Index Fix" -ForegroundColor Cyan
...
Write-Host ""
Write-Host "==========================" -ForegroundColor Cyan
Write-Host "v42d fertig!" -ForegroundColor Cyan
Write-Host "==========================" -ForegroundColor Cyan
Write-Host ""
Write-Host "Root-Ursache behoben:" -ForegroundColor Green
Write-Host "  BackgroundCanvas: position fixed, z-index 0" -ForegroundColor White
Write-Host "  Seiten-Inhalt hatte KEINEN z-index -> lag hinter Canvas" -ForegroundColor White
Write-Host "  Fix: <div style='position:relative; z-index:1'> in layout.tsx" -ForegroundColor White
Write-Host ""
Write-Host "GitHub Desktop -> Commit 'v42d: fix z-index'" -ForegroundColor Yellow
