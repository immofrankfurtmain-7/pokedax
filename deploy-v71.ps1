...
Write-Host "pokEdax v7.1" -ForegroundColor Yellow
Write-Host ""
Write-Host "Fixes:" -ForegroundColor Cyan
Write-Host "  [1] Sets: Bilder (symbol_url + logo_url) jetzt in API" -ForegroundColor Green
Write-Host "  [2] Preischeck: Set-Dropdown Filter" -ForegroundColor Green
Write-Host "  [3] Auth: Bearer Token in allen fetch-Aufrufen" -ForegroundColor Green
Write-Host "  [4] Forum/Fantasy/Marktplatz: nicht mehr 'bitte anmelden'" -ForegroundColor Green
Write-Host ""
...
Write-Host "Schreibe..." -ForegroundColor DarkGray
...
Write-Host ""
Write-Host "v7.1 fertig!" -ForegroundColor Yellow
Write-Host "GitHub Desktop -> Commit 'v7.1: sets images + auth fix + set filter'" -ForegroundColor Yellow
